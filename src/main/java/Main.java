...
public class Main {
    public static void main(String[] args) {
        ...
        Bank bank = bankService.create(new Bank("Сбер", 1000, 1000, 10000, 99999));
        System.out.print(bank);

        BankOfficeService bankOfficeService = new BankOfficeServiceImpl();
        BankOffice bankOffice = bankOfficeService.create(new BankOffice("Офис банка 1", "ул. Королева, 2Г", true, true, 10, true, true, true, 10000000, 10000, bank));
